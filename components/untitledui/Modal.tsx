...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
      ...
      {/* Modal Dialog */}
      <div
        className={`relative z-10 w-full ${maxWidthStyles[maxWidth]} rounded-2xl bg-white border border-gray-200 shadow-2xl transition-all animate-in zoom-in-95 duration-200 overflow-hidden flex flex-col my-8 font-sans ${className}`}
        role="dialog"
        aria-modal="true"
      >
        {/* Header */}
